...
//
// It shares the SAME session cookie (sess_gpx), secret, providers, and
...
const silentAuthConfig: NextAuthConfig = {
  ...
  cookies: {
    ...
    csrfToken: silentTxnCookie("csrf_gpx_silent"),
    callbackUrl: silentTxnCookie("callback_gpx_silent"),
    state: silentTxnCookie("state_gpx_silent", 900),
    pkceCodeVerifier: silentTxnCookie("pkce_gpx_silent", 900),
    nonce: silentTxnCookie("nonce_gpx_silent", 900),
  },
};
