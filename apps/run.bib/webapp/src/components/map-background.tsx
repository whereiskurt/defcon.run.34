...
/**
 * MapBackground — the "Las Vegas" parallax background, ported from run.human
 * (v1.6). A fixed full-viewport layer paints a Vegas map tile and follows the
...
type BgPrefs = { zoom: number; opacity: number; parallax: boolean };

const DEFAULT_PREFS: BgPrefs = { zoom: 10, opacity: 15, parallax: true };
          ...
          <PopoverContent className="w-64 p-4 space-y-4">
            ...
            <div>
              ...
              <Slider
                ...
                classNames={{ track: "h-1", filler: "bg-primary" }}
