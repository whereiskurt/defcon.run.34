        ...
        >
          <input
            ...
            style={{
              ...
              color: nameLocked ? "var(--bib-faint)" : "#0a0a0a",
              backgroundColor: nameLocked ? "var(--bib-border-2)" : "#fff",
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 700,
              color: canSave ? "#0a0a0a" : "var(--bib-faint)",
              backgroundColor: canSave ? "#6CCDB8" : "var(--bib-border-2)",
              border: "none",
              borderRadius: 6,
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13,
              fontWeight: 600,
              color: !dirty || saving ? "var(--bib-faint)" : "var(--bib-ink)",
