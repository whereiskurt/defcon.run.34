...
//
// It shares the SAME session cookie (sess_flash), secret, providers, and
...
const silentAuthConfig: NextAuthConfig = {
  ...
  cookies: {
    ...
    csrfToken: silentTxnCookie("csrf_flash_silent"),
    callbackUrl: silentTxnCookie("callback_flash_silent"),
    state: silentTxnCookie("state_flash_silent", 900),
    pkceCodeVerifier: silentTxnCookie("pkce_flash_silent", 900),
    nonce: silentTxnCookie("nonce_flash_silent", 900),
  },
};
