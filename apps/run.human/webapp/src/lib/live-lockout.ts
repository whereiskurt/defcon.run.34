 ...
 *
 * Read access can ride the warm JWT session (re-validated on run.human's ~5-min
...
/**
 * @param authUserId the run.auth sub (session.user.authUserId), NOT the run.human id.
