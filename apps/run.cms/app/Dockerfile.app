...
RUN wget -qO- "https://github.com/benbjohnson/litestream/releases/download/v${LITESTREAM_VERSION}/litestream-vfs-v${LITESTREAM_VERSION}-linux-amd64.tar.gz" | tar xz -C /usr/local/bin
