  ...
  secrets = {
    ...
    definitions = {
      ...
      mqtt = {
        ...
        keys        = ["meshtk-proxy-password", "meshobserv-password", "ghosts-password", "max-connections", "s3-log-interval", "channel-psk", "ghost-start-delay", "ghost-key-secret", "flag-challenges"]
      }
    }
  }
