# Requirements: v1.5 Bib Registration (shipped 2026-07-03)

> **ARCHIVED.** v1.5 shipped to bib.defcon.run on 2026-07-03 (first release v0.0.18). The payment requirements below diverged from what shipped — see the Kurt design contract (2026-07-02) captured in `v1.5-WORKSTREAM-STATE.md` and the traceability table at the bottom for actual delivery status.
...
|-------------|-------|--------|
| BIB-01 | Phase 20 | ✅ Done |
| BIB-02 | Phase 20 | ✅ Done |
| BIB-03 | Phase 20 | ✅ Done |
| BIB-04 | Phase 20 | ⚠️ Partial — Stripe SSM done; PayPal secrets N/A (PayPal cut) |
| BIB-05 | Phase 20 | ✅ Done |
| BIB-06 | Phase 21 | ✅ Done |
| BIB-07 | Phase 21 | ⚠️ Done w/ change — size field dropped (design contract) |
| BIB-08 | Phase 21 | ✅ Done |
| BIB-09 | Phase 21 | ✅ Done |
| BIB-10 | Phase 21 | ✅ Done |
| BIB-18 | Phase 21 | ✅ Done |
| BIB-21 | Phase 21 | ✅ Done |
| BIB-11 | Phase 22 | 🔄 Superseded — custom-amount slider replaced preset tiers |
| BIB-20 | Phase 22 | 🔄 Superseded — Stripe/Venmo/CashApp chooser (no provider registry) |
| BIB-12 | Phase 22 | ✅ Done — willPayInPerson pledge path |
| BIB-13 | Phase 22 | ⚠️ Partial — Stripe Checkout shipped; no PaymentProvider registry / `fake` provider (direct integration) |
| BIB-19 | Phase 22 | 🔄 Superseded — PayPal cut; Venmo/CashApp via SES→Haiku reconciliation |
| BIB-14 | Phase 22 | ✅ Done |
| BIB-15 | Phase 23 | ✅ Done |
| BIB-16 | Phase 23 | ✅ Done |
| BIB-17 | Phase 23 | ✅ Done (us-east-1; ca-central-1 not deployed for bib) |

**Coverage:** 21 requirements — 15 delivered as specified, 3 superseded by the 2026-07-02 design contract (tiers→slider, PayPal→Venmo/CashApp, registry→direct), 2 partial (SSM/PayPal secrets, no provider seam), size field dropped. Crypto BTC/ETH remains deferred (PAY-01).
