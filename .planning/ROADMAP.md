...
- [x] 40-04-PLAN.md — admin-reports module: metric filters + 90d retention + admin/* queries + wiring (wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 40-05-PLAN.md — Mapbox hardening + reading-the-reports runbook (wave 2)
- [x] 40-06-PLAN.md — admin-reports dashboard + SNS tripwire alarms (wave 2)
