...
Plans:
- [ ] 70-01-PLAN.md — Shared dialog kit in `dialog-shell/`: DialogShell, Section, Row, Chips, Chip, HintBar (DLGS-01)
- [ ] 70-02-PLAN.md — StravaStrip explicit card chips: "Pick a day" / "+ Import" (DLGS-05)
