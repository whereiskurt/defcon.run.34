...
Plans:
- [ ] 03-01-PLAN.md -- Server-side foundation: types, config, DynamoDB entities, /api/config endpoint
- [ ] 03-02-PLAN.md -- @meshtastic/core wrapper library and useConfigure hook for config push pipeline
